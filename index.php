<?php
  ...
  {
      $query="INSERT INTO `unitedstocks` (`id`,`BuyDate`, `Stock Name`, `Quantity`, `Price`, `Buyer Info`, `Status`) VALUES (NULL,'".$_POST['Date']."', '".$_POST['StockName']."', '".$_POST['Quantity']."', '".$_POST['Price']."',  '".$_POST['BuyerInfo']."', '1')";
